...
class _RadialAnimationState extends State<RadialAnimation> {
      ...
      builder: (context, builder) {
        return Transform.rotate(
          ...
          child: Stack(
            ...
            children: [
              _buildButton(widget.finalAngle, 0,
                  color: Colors.black, icon: FontAwesomeIcons.thumbtack),
              _buildButton(widget.finalAngle, 30,
                  color: Colors.green, icon: FontAwesomeIcons.sprayCan),
              _buildButton(widget.finalAngle, 60,
                  color: Colors.orange, icon: FontAwesomeIcons.fire),
              _buildButton(widget.finalAngle, 90,
                  color: Colors.blue, icon: FontAwesomeIcons.kiwiBird),
              _buildButton(widget.finalAngle, 120,
                  color: Colors.black, icon: FontAwesomeIcons.cat),
              _buildButton(widget.finalAngle, 150,
                  color: Colors.indigo, icon: FontAwesomeIcons.paw),
              _buildButton(widget.finalAngle, 180,
                  color: Colors.pink, icon: FontAwesomeIcons.bong),
              _buildButton(widget.finalAngle, 210,
                  color: Colors.yellow, icon: FontAwesomeIcons.bolt),
              _buildButton(widget.finalAngle, 240,
                  color: Colors.red, icon: FontAwesomeIcons.thumbtack),
              _buildButton(widget.finalAngle, 270,
                  color: Colors.green, icon: FontAwesomeIcons.sprayCan),
              _buildButton(widget.finalAngle, 300,
                  color: Colors.orange, icon: FontAwesomeIcons.fire),
              _buildButton(widget.finalAngle, 330,
                  color: Colors.blue, icon: FontAwesomeIcons.kiwiBird),
              _buildButton(widget.finalAngle, 360,
                  color: Colors.pink, icon: FontAwesomeIcons.bong),
              Transform.scale(
  ...
  _buildButton(finalAngle, double angle, {Color color, IconData icon}) {
